import { Box, Text, Flex, Grid } from "@chakra-ui/react"; // Added Grid import
...
const PreviewCard: React.FC<{
  ...
  return (
    <Box p="1rem" maxWidth="800px" mx="auto"> {/* Centering the card */}
      <Box borderRadius="10px" bgColor="gray.100" height="fit-content">
          ...
          >
            ...
            >
              <Text fontSize="0.9rem" fontWeight="500">
                {requisitionDetails?.requisitionTitle || "No Title Available"}
              </Text>
        ...
        <Box maxH="50rem" overflowY="auto" px="24px" pb="24px">
          ...
          <DataCard title="Job Detail">
            <KeyValue title="Job Title" value={jobDetails?.jobTitle || "N/A"} />
            <KeyValue title="Job Details" value={jobDetails?.jobDetails || "N/A"} />
            <KeyValue title="Job Location" value={jobDetails?.jobLocation || "N/A"} />
          </DataCard>
